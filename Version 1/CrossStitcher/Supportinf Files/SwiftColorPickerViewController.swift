...
final public class SwiftColorPickerViewController: UIViewController
{
    ...
    public override func viewDidLoad() {
        ...
        let tapGr = UITapGestureRecognizer(target: self, action: #selector(self.handleGestureRecognizer))
        let panGr = UIPanGestureRecognizer(target: self, action: #selector(self.handleGestureRecognizer))
    ...
    private func setConstraintsForColorPreView()
    {
        ...
        let constH2 = NSLayoutConstraint.constraints(withVisualFormat: "H:|-pad-[selectionView(diameter)]", options: [.alignAllTrailing], metrics: metrics, views: views)
        ...
        let constV2 = NSLayoutConstraint.constraints(withVisualFormat: "V:|-pad-[selectionView(diameter)]", options: [.alignAllTrailing], metrics: metrics, views: views)
